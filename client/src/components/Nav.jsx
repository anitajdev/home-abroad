...
const Nav = () => {
  ...
  return (
    ...
    <header className="padding-x py-8 w-full">
      <nav className="flex justify-between items-center sticky max-container">
        <div>
          <Link to={"/"}>
        ...
        <div className="flex items-center gap-5 border border-gray-300 rounded-xl px-4 py-2 shadow-md shadow-gray-300">
          <div>Where</div>
        ...
        <Link to={user? "/account" : "/login"} className="flex border border-gray-300 rounded-xl items-center gap-[5px] px-3 py-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
